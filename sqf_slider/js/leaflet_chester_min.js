...
(function (a) {
    ...
    popupAnchor: new L.Point(0, -33),
	    ...
	    _createIcon: function (a) {
	        var d;
			q++;
	        return d = this._createDiv(), d.className = "leaflet-marker-custom", d.id = "marker_" + q, d.style.marginLeft = -this.iconAnchor.x + "px", d.style.marginTop = -this.iconAnchor.y + "px", d
	    },
	    _createDiv: function () {
	        return document.createElement("div")
	    }
    ...
    _fireMouseEvent: function (a) {
	    ...
	    onAdd: function (a) {
	        this._map = a, this._initIcon(), this._reset()
	    },
	    onRemove: function (a) {
	        this._removeIcon(), this.closePopup && this.closePopup(), this._map = null, a.off("viewreset", this._reset, this)
	    },
	    ...
	    setIcon: function (a) {
	        this._map, this.options.icon = a, this._map && (this._initIcon(), this._reset())
	    },
	     _initIcon: function () {
	     	this._icon || (this._icon = this.options.icon.createIcon()), this._map._panes.markerPane.appendChild(this._icon)
	    },
	    _reset: function () {
	        var a = this._map.latLngToLayerPoint(this._latlng).round();
