...
(function (a) {
    ...
    _fireMouseEvent: function (a) {
...
}),	 L.Marker_custom = L.Class.extend({
	    includes: L.Mixin.Events,
	    options: {
	        icon: new L.Icon_custom,
	        title: "",
	        clickable: !0,
	        draggable: !1,
	        zIndexOffset: 0
	    ...
	    onRemove: function (a) {
	        L.Util.falseFn(this._container.offsetWidth), a.off("viewreset", this._updatePosition, this), a.off("click", this._close, this), this._container.style.opacity = "0", this._opened = !1
	    },
	    setLatLng: function (a) {
	    ...
	    _initLayout: function () {
			this._container = L.DomUtil.create("div", "leaflet-popup_custom" + this.options.className)
	    },
	    _update: function () {
